...
use App\Http\Controllers\Api\Auth\LoginJwtfController;
...
Route::prefix('v1')->group(function(){
    Route::post('login',[LoginJwtfController::class, 'login'])->name('login');
    Route::get('logout',[LoginJwtfController::class, 'logout'])->name('logout');
    Route::get('refresh',[LoginJwtfController::class, 'refresh'])->name('refresh');

    Route::get('/search', [RealStateSearchController::class, 'index'])->name('search');
    Route::get('/search{Real_state_ id}', [RealStateSearchController::class, 'show'])->name('search_single');
